...
Then, I started coding the frontend in React. I created four subpages: home (where users vote for books), rankings (where users can view the rankings of all books), add (where users can add their own books), and a sign-in page for users to login and obtain a new valid JWT.
